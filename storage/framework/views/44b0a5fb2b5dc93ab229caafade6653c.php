...
<head>
    ...
    <link rel="canonical" href="<?php echo e(url('/reset-password')); ?>">
...
<body>
    ...
    <div class="auth-container">
        ...
        <?php if(isset($valid) && $valid): ?>
            <form method="POST" action="<?php echo e(url('/reset-password')); ?>" id="resetPasswordForm">
                <?php echo csrf_field(); ?>
        ...
        <div class="auth-footer" style="margin-top: 1.5rem;">
            Remember your password? <a href="<?php echo e(url('/login')); ?>">Login</a>
        </div>
    </div>
...
<?php /**PATH C:\Users\Cocotantan\Downloads\--CAS WEBSITE-- - Copy (4)\resources\views/reset-password.blade.php ENDPATH**/ ?>