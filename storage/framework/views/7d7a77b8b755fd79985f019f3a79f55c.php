...
<head>
    ...
    <link rel="canonical" href="<?php echo e(url('/contractor-partner')); ?>">
    
    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo e(url('/contractor-partner')); ?>">
    ...
    <meta property="twitter:url" content="<?php echo e(url('/contractor-partner')); ?>">
    ...
    echo json_encode([
      ...
      'workHours' => 'Flexible, 24/7 availability',
      'skills' => 'Caregiving, Personal Care, Elderly Care, Home Care Services'
    ], JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT);
    ?>
    </script>
...
<body>
        ...
        <div class="hero-content">
            <div class="hero-left">
                ...
                <div class="hero-buttons">
                    <a href="<?php echo e(url('/register?show_partner_types=true')); ?>" class="btn-primary">Join as Partner Today</a>
                </div>
            </div>
    ...
    <section class="section-light" style="padding: 6rem 2rem;" id="income-section">
    ...
    <section class="section-dark" style="padding: 6rem 2rem;">
        <div class="container" style="max-width: 1200px; margin: 0 auto;">
            <div class="section-header fade-in" style="text-align: center; margin-bottom: 4rem;">
                <h2 style="font-size: 3rem; font-weight: 700; margin-bottom: 1rem;">
            ...
            <div class="steps-container">
                <div class="step fade-in">
                    ...
                    <div class="step-content">
                        <h3><span style="color: #f97316;">Sign Up</span> <span style="background: linear-gradient(135deg, #3b82f6 0%, #1e40af 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">& Get Verified</span></h3>
                        <p>Complete your profile, submit required documents, and pass our verification process. We'll help you every step of the way.</p>
                    </div>
                </div>
                <div class="step fade-in">
    ...
    <section class="section-light" id="referral-incentives" style="padding: 6rem 2rem;">
        <div class="container" style="max-width: 1200px; margin: 0 auto;">
            <div class="section-header fade-in" style="text-align: center; margin-bottom: 4rem;">
                <h2 style="font-size: 3rem; font-weight: 700; margin-bottom: 1rem;">
    ...
    <section class="section-dark" id="why-partner" style="padding: 6rem 2rem;">
        <div class="container" style="max-width: 1200px; margin: 0 auto;">
            <div class="section-header fade-in" style="text-align: center; margin-bottom: 5rem;">
                <h2 style="font-size: 3rem; font-weight: 700; margin-bottom: 1rem;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr)); gap: 1.5rem;">
                <div class="fade-in" style="background: white; padding: 2rem; border-radius: 16px; box-shadow: 0 2px 8px rgba(0,0,0,0.08); border: 1px solid #e5e7eb; display: flex; align-items: flex-start; gap: 1.5rem; transition: all 0.3s ease;">
                    ...
                    <div style="flex: 1;">
                        <h3 style="font-size: 1.25rem; font-weight: 700; color: #111827; margin-bottom: 0.5rem; letter-spacing: -0.01em;">Competitive Rates</h3>
                        <p style="color: #6b7280; line-height: 1.6; font-size: 0.95rem; margin: 0;"><span style="color: #10b981; font-weight: 700;">$28/hour</span> base rate with transparent earnings breakdown</p>
                    </div>
                </div>
                ...
                <div class="fade-in" style="background: white; padding: 2rem; border-radius: 16px; box-shadow: 0 2px 8px rgba(0,0,0,0.08); border: 1px solid #e5e7eb; display: flex; align-items: flex-start; gap: 1.5rem; transition: all 0.3s ease;">
                    ...
                    <div style="flex: 1;">
                        <h3 style="font-size: 1.25rem; font-weight: 700; color: #111827; margin-bottom: 0.5rem; letter-spacing: -0.01em;">Verified Network</h3>
                        <p style="color: #6b7280; line-height: 1.6; font-size: 0.95rem; margin: 0;">Work with verified clients in a safe, trusted platform</p>
                    </div>
                </div>
                
                <div class="fade-in" style="background: white; padding: 2rem; border-radius: 16px; box-shadow: 0 2px 8px rgba(0,0,0,0.08); border: 1px solid #e5e7eb; display: flex; align-items: flex-start; gap: 1.5rem; transition: all 0.3s ease;">
                    <div style="width: 56px; height: 56px; background: #f0f9ff; border-radius: 12px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                        <i class="bi bi-star-fill" style="font-size: 1.75rem; color: #3b82f6;"></i>
                    </div>
                    <div style="flex: 1;">
                        <h3 style="font-size: 1.25rem; font-weight: 700; color: #111827; margin-bottom: 0.5rem; letter-spacing: -0.01em;">Build Your Reputation</h3>
                        <p style="color: #6b7280; line-height: 1.6; font-size: 0.95rem; margin: 0;">Earn reviews and ratings to attract more clients</p>
                    </div>
                </div>
                
                <div class="fade-in" style="background: white; padding: 2rem; border-radius: 16px; box-shadow: 0 2px 8px rgba(0,0,0,0.08); border: 1px solid #e5e7eb; display: flex; align-items: flex-start; gap: 1.5rem; transition: all 0.3s ease;">
                    <div style="width: 56px; height: 56px; background: #f0f9ff; border-radius: 12px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                        <i class="bi bi-wallet2" style="font-size: 1.75rem; color: #3b82f6;"></i>
                    </div>
                    <div style="flex: 1;">
                        <h3 style="font-size: 1.25rem; font-weight: 700; color: #111827; margin-bottom: 0.5rem; letter-spacing: -0.01em;">Regular Payments</h3>
                        <p style="color: #6b7280; line-height: 1.6; font-size: 0.95rem; margin: 0;">Get paid on time with detailed earnings reports</p>
                    </div>
                </div>
                
                <div class="fade-in" style="background: white; padding: 2rem; border-radius: 16px; box-shadow: 0 2px 8px rgba(0,0,0,0.08); border: 1px solid #e5e7eb; display: flex; align-items: flex-start; gap: 1.5rem; transition: all 0.3s ease;">
                    <div style="width: 56px; height: 56px; background: #f0f9ff; border-radius: 12px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                        <i class="bi bi-headset" style="font-size: 1.75rem; color: #3b82f6;"></i>
                    </div>
                    <div style="flex: 1;">
                        <h3 style="font-size: 1.25rem; font-weight: 700; color: #111827; margin-bottom: 0.5rem; letter-spacing: -0.01em;">24/7 Support</h3>
                        <p style="color: #6b7280; line-height: 1.6; font-size: 0.95rem; margin: 0;">Access support whenever you need help or have questions</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section-light" style="padding: 7rem 2rem; position: relative; overflow: hidden;">
        <div class="container" style="max-width: 1200px; margin: 0 auto; position: relative; z-index: 1;">
            <div class="section-header fade-in" style="text-align: center;">
                <h2 style="font-size: 3rem; font-weight: 700; margin-bottom: 1rem;"><span style="color: #f97316;">Ready</span> to Start Earning?</h2>
                <p style="color: #64748b; font-size: 1.2rem;">Join hundreds of caregivers already earning with CAS Private Care. Transparent rates, flexible schedule, and ongoing support.</p>
            </div>
 ...
 <?php /**PATH C:\Users\Cocotantan\Downloads\--CAS WEBSITE-- - Copy (4)\resources\views/contractor-partner.blade.php ENDPATH**/ ?>