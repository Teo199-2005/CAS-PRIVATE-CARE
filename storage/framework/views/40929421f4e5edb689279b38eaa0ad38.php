...
<head>
    ...
    <link rel="canonical" href="<?php echo e(url('/register')); ?>">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <div class="modal-logo">
                    <img src="<?php echo e(asset('logo flower.png')); ?>" alt="CAS Private Care LLC Logo">
                </div>
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>" id="registerForm">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="first_name" name="first_name" class="form-input" placeholder="Enter your first name" value="<?php echo e(session('oauth_user.name') ? explode(' ', session('oauth_user.name'))[0] : old('first_name')); ?>" required autocomplete="given-name" aria-required="true" pattern="[A-Za-z\s]+" title="Only letters and spaces are allowed" oninput="this.value = this.value.replace(/[^A-Za-z\s]/g, '')">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" class="form-input" placeholder="your@email.com" value="<?php echo e(session('oauth_user.email') ?? old('email')); ?>" <?php echo e(session('oauth_user.email') ? 'readonly' : ''); ?> required autocomplete="email" aria-required="true">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="tel" id="phone" name="phone" class="form-input" placeholder="(646) 282-8282" value="<?php echo e(old('phone')); ?>" required autocomplete="tel" aria-required="true" maxlength="14">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" id="zip_code" name="zip_code" class="form-input" placeholder="Enter ZIP code" value="<?php echo e(old('zip_code')); ?>" required autocomplete="postal-code" aria-required="true" pattern="[0-9]{5}" maxlength="5" inputmode="numeric">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="social-login">
            ...
            <a href="<?php echo e(url('/auth/google' . $oauthUrlParams)); ?>" class="social-btn" id="googleOAuthBtn">
            ...
            <a href="<?php echo e(url('/auth/facebook' . $oauthUrlParams)); ?>" class="social-btn" id="facebookOAuthBtn">
    ...
    <script>
        ...
        const presetType = urlParams.get('type') || '<?php echo e(old("user_type", "")); ?>';
        ...
        const hasOAuthUser = <?php echo e(session('oauth_user') ? 'true' : 'false'); ?>;
...
<?php /**PATH C:\Users\Cocotantan\Downloads\--CAS WEBSITE-- - Copy (4)\resources\views/register.blade.php ENDPATH**/ ?>