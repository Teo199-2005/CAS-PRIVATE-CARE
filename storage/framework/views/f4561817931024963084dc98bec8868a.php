...
<head>
    ...
    <meta property="twitter:url" content="<?php echo e(url('/about')); ?>">
                ...
                <div class="founder-section">
                    <div class="founder-content">
                        <div class="founder-image">
                            <img src="<?php echo e(asset('CEO.jpg')); ?>" alt="Charles Andrew Santiago - CEO and Founder of CAS Private Care LLC" loading="lazy">
        ...
        <section class="section-dark" style="padding: 7rem 2rem; background: linear-gradient(135deg, #3b82f6, #1e40af); color: white; text-align: center;">
            <div class="container">
                ...
                <div style="display: flex; gap: 1.5rem; justify-content: center; flex-wrap: wrap;">
                    <a href="<?php echo e(url('/register')); ?>" style="display: inline-block; background: white; color: #3b82f6; padding: 1rem 2.5rem; border-radius: 10px; text-decoration: none; font-weight: 600; font-size: 1.1rem; transition: transform 0.3s ease;">
                        Get Started Today
                    </a>
                    <a href="<?php echo e(url('/caregiver-new-york')); ?>" style="display: inline-block; background: transparent; border: 2px solid white; color: white; padding: 1rem 2.5rem; border-radius: 10px; text-decoration: none; font-weight: 600; font-size: 1.1rem; transition: transform 0.3s ease;">
                        Learn More
                    </a>
                </div>
            </div>
...
<?php /**PATH C:\Users\Cocotantan\Downloads\--CAS WEBSITE-- - Copy (4)\resources\views/about.blade.php ENDPATH**/ ?>