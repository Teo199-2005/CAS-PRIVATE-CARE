          ...
          <v-row class="mt-1">
            <v-col cols="12">
              <v-row align="stretch">
                <v-col cols="12" lg="6">
                  <v-card elevation="1" class="mb-3 enhanced-card d-flex flex-column h-100">
                    <v-card-title class="enhanced-card-header pa-4">
                      <v-icon color="success" size="22" class="mr-2">mdi-clock-time-four</v-icon>
                      <span class="section-title-compact success--text">Time Tracking</span>
                    </v-card-title>
                    <v-card-text class="pa-4 flex-grow-1 d-flex flex-column justify-space-between">
                      <div>
                ...
                <v-col cols="12" lg="6">
                  <v-card class="mb-3 enhanced-card d-flex flex-column h-100" elevation="1">
                    <v-card-title class="enhanced-card-header pa-4">
                      <v-icon color="success" size="22" class="mr-2">mdi-chart-line</v-icon>
                      <span class="section-title-compact success--text">Previous Week Summary</span>
                    </v-card-title>
