  ...
  >
    ...
    <div v-if="currentSection === 'admin-staff'">
      ...
      <v-card elevation="0">
        ...
        <v-data-table 
          :headers="adminStaffHeaders" :items="filteredAdminStaff" :items-per-page="10" 
          class="elevation-0" 
          density="compact"
        >
    ...
    <div v-if="currentSection === 'training-centers'">
      ...
      <v-card elevation="0">
        ...
        <v-data-table :headers="trainingCenterHeaders" :items="filteredTrainingCenters" :items-per-page="10" class="elevation-0" density="compact">
    ...
    <div v-if="currentSection === 'client-bookings'">
      ...
      <v-card elevation="0">
        ...
        <v-data-table :headers="bookingHeaders" :items="filteredBookings" :items-per-page="10" :items-per-page-options="[10, 25, 50, -1]" class="elevation-0 admin-bookings-table" density="compact">
          ...
          <v-card elevation="0" class="mb-6">
            ...
            <v-card-text class="pa-8">
              <v-row>
                ...
                <v-col cols="12" md="6">
                  <v-text-field v-model="profileData.department" label="Department" variant="outlined" readonly />
                </v-col>
                <v-col cols="12" md="6">
                  <v-text-field v-model="profileData.role" label="Admin Role" variant="outlined" readonly />
                </v-col>
              </v-row>
...
const loadProfile = async () => {
  try {
    ...
    if (response.ok) {
      ...
      profile.value.role = data.role || 'Admin Staff';
      profile.value.department = data.department || 'System Administration';
      ...
      profileData.value.role = profile.value.role;
      profileData.value.department = profile.value.department;
      if (data.avatar) {
