    ...
    <div v-if="currentSection === 'payments'">
      <v-row>
        <v-col cols="12" md="8">
                  ...
                  <div class="payment-card visa-card">
                    ...
                    <div class="card-info">
                      <div class="card-holder">
                        ...
                        <div class="card-value">TRAINING CENTER</div>
                      </div>
          ...
          <v-card elevation="0">
            <v-card-title class="card-header pa-6">
              <span class="section-title grey--text text--darken-2">Revenue History</span>
            </v-card-title>
            <v-card-text class="pa-6">
              <v-data-table :headers="revenueHeaders" :items="revenueHistory" :items-per-page="10" class="elevation-0">
                <template v-slot:item.status="{ item }">
        ...
        <v-col cols="12" md="4">
          <v-card elevation="0" class="mb-6">
            <v-card-title class="card-header pa-6">
              <span class="section-title grey--text text--darken-2">Revenue Overview</span>
            </v-card-title>
            <v-card-text class="pa-6">
              <div class="earning-overview">
                <div class="earning-stat mb-4">
                  <div class="earning-amount grey--text text--darken-2">${{ totalRevenue }}</div>
                  <div class="earning-desc">Total Revenue</div>
                </div>
                <div class="earning-stat mb-4">
                  <div class="earning-amount">${{ monthlyRevenue }}</div>
                  <div class="earning-desc">This Month</div>
                </div>
                <div class="earning-stat mb-4">
                  <div class="earning-amount">$850.00</div>
